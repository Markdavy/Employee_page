...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="add"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Add New Personal Information</h4>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane show active fade" id="TabPage-1-Page1" role="tabpanel">
                                    ...
                                    <div  class="bg-light p-3 animated fadeIn page-content">
                                        <form id="personal_information-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="<?php print_link("personal_information/add?csrf_token=$csrf_token") ?>" method="post">
                                            <div>
                                                                                    ...
                                                                                    <div class="form-group ">
                                                                                        ...
                                                                                        <div class="form-group ">
                                                                                            <div class="row">
                                                                                                ...
                                                                                                <div class="col-sm-8">
                                                                                                    <div class="">
                                                                                                        <input id="ctrl-monthly_salary"  value="<?php  echo $this->set_field_value('monthly_salary',""); ?>" type="text" placeholder="Enter Monthly Salary"  required="" name="monthly_salary"  class="form-control " />
                                                                                                        </div>
                                                                                                    </div>
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="form-group ">
                                                                                                <div class="row">
                                                                                                    ...
                                                                                                    <div class="col-sm-8">
                                                                                                        <div class="">
                                                                                                            <input id="ctrl-account_bonus"  value="<?php  echo $this->set_field_value('account_bonus',""); ?>" type="text" placeholder="Enter Account Bonus"  required="" name="account_bonus"  class="form-control " />
                                                                                                            </div>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                </div>
                                                                                                ...
                                                                                                <div class="form-group ">
                                                                                                    <div class="row">
                                                                                                        ...
                                                                                                        <div class="col-sm-8">
                                                                                                            <div class="">
                                                                                                                <input id="ctrl-employment_status"  value="<?php  echo $this->set_field_value('employment_status',""); ?>" type="text" placeholder="Enter Employment Status"  required="" name="employment_status"  class="form-control " />
                                                                                                                </div>
                                                                                                            </div>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                    <div class="form-group ">
                                                                                                        <div class="row">
                                                                                                            ...
                                                                                                            <div class="col-sm-8">
                                                                                                                <div class="">
                                                                                                                    <input id="ctrl-start_shift_day"  value="<?php  echo $this->set_field_value('start_shift_day',""); ?>" type="text" placeholder="Enter Start Shift Day"  required="" name="start_shift_day"  class="form-control " />
                                                                                                                    </div>
                                                                                                                </div>
                                                                                                            </div>
                                                                                                        </div>
                                                                                                        <div class="form-group ">
                                                                                                            <div class="row">
                                                                                                                ...
                                                                                                                <div class="col-sm-8">
                                                                                                                    <div class="">
                                                                                                                        <input id="ctrl-end_shift_day"  value="<?php  echo $this->set_field_value('end_shift_day',""); ?>" type="text" placeholder="Enter End Shift Day"  required="" name="end_shift_day"  class="form-control " />
                                                                                                                        </div>
                                                                                                                    </div>
                                                                                                                </div>
                                                                                                            </div>
                                                                                                            <div class="form-group ">
                                                                                                                ...
                                                                                                                <div class="form-group ">
                                                                                                                    <div class="row">
                                                                                                                        ...
                                                                                                                        <div class="col-sm-8">
                                                                                                                            <div class="input-group">
                                                                                                                                <input id="ctrl-shift_time_out" class="form-control datepicker  datepicker"  required="" value="<?php  echo $this->set_field_value('shift_time_out',""); ?>" type="time" name="shift_time_out" placeholder="Enter Shift Time Out" data-enable-time="true" data-min-date="" data-max-date=""  data-alt-format="H:i" data-date-format="H:i:S" data-inline="false" data-no-calendar="true" data-mode="single" /> 
                                                                                                                                    <div class="input-group-append">
                                                                                                                                        <span class="input-group-text"><i class="material-icons">access_time</i></span>
                                                                                                                                    </div>
                                                                                                                                </div>
                                                                                                                    ...
                                                                                                                    <div class="form-group ">
                                                                                                                        <div class="row">
                                                                                                                            ...
                                                                                                                            <div class="col-sm-8">
                                                                                                                                <div class="">
                                                                                                                                    <input id="ctrl-lunch_break_start"  value="<?php  echo $this->set_field_value('lunch_break_start',""); ?>" type="text" placeholder="Enter Lunch Break Start"  required="" name="lunch_break_start"  class="form-control " />
                                                                                                                                    </div>
                                                                                                                                </div>
                                                                                                                            </div>
                                                                                                                        </div>
                                                                                                                        <div class="form-group ">
                                                                                                                            <div class="row">
                                                                                                                                ...
                                                                                                                                <div class="col-sm-8">
                                                                                                                                    <div class="">
                                                                                                                                        <input id="ctrl-sss_number"  value="<?php  echo $this->set_field_value('sss_number',""); ?>" type="number" placeholder="Enter SSS Number" step="1"  required="" name="sss_number"  class="form-control " />
                                                                                                                                        </div>
                                                                                                                                    </div>
                                                                                                                                </div>
                                                                                                                            </div>
                                                                                                                            <div class="form-group ">
                                                                                                                                ...
                                                                                                                                <div class="form-group ">
                                                                                                                                    <div class="row">
                                                                                                                                        ...
                                                                                                                                        <div class="col-sm-8">
                                                                                                                                            <div class="">
                                                                                                                                                <input id="ctrl-pagibig_number"  value="<?php  echo $this->set_field_value('pagibig_number',""); ?>" type="number" placeholder="Enter Pag-ibig Number" step="1"  required="" name="pagibig_number"  class="form-control " />
                                                                                                                                                </div>
                                                                                                                                            </div>
                                                                                                                                        </div>
                                                                                                                                    </div>
                                                                                                                                    <div class="form-group ">
                                                                                                                                        ...
                                                                                                                                        <div class="form-group ">
                                                                                                                                            <div class="row">
                                                                                                                                                ...
                                                                                                                                                <div class="col-sm-8">
                                                                                                                                                    <div class="">
                                                                                                                                                        <input id="ctrl-philhealth_number"  value="<?php  echo $this->set_field_value('philhealth_number',""); ?>" type="number" placeholder="Enter Philhealth Number" step="1"  required="" name="philhealth_number"  class="form-control " />
                                                                                                                                                        </div>
                                                                                                                                                    </div>
                                                                                                                                                </div>
                                                                                                                                            </div>
                                                                                                                                            <div class="form-group ">
                                                                                                                                                ...
                                                                                                                                                <div class="form-group ">
                                                                                                                                                    <div class="row">
                                                                                                                                                        ...
                                                                                                                                                        <div class="col-sm-8">
                                                                                                                                                            <div class="">
                                                                                                                                                                <input id="ctrl-tin_number"  value="<?php  echo $this->set_field_value('tin_number',""); ?>" type="number" placeholder="Enter TIN Number" step="1"  required="" name="tin_number"  class="form-control " />
                                                                                                                                                                </div>
                                                                                                                                                            </div>
                                                                                                                                                        </div>
                                                                                                                                                    </div>
