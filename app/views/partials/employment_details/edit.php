...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="edit"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Edit  Employment Details</h4>
                </div>
            ...
            <div class="row ">
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("employment_details/edit/$page_id/?csrf_token=$csrf_token"); ?>" method="post">
                            <div>
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <input id="ctrl-monthly_salary"  value="<?php  echo $data['monthly_salary']; ?>" type="number" placeholder="Enter Monthly Salary" step="1"  required="" name="monthly_salary"  class="form-control " />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input id="ctrl-account_bonus"  value="<?php  echo $data['account_bonus']; ?>" type="number" placeholder="Enter Account Bonus" step="1"  required="" name="account_bonus"  class="form-control " />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <select required=""  id="ctrl-employee_status" name="employee_status"  placeholder="Select a value ..."    class="custom-select" >
                                                                ...
                                                                $field_value = $data['employee_status'];
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <select required=""  id="ctrl-start_shift_day" name="start_shift_day"  placeholder="Select a value ..."    class="custom-select" >
                                                                ...
                                                                $field_value = $data['start_shift_day'];
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <select required=""  id="ctrl-end_shift_day" name="end_shift_day"  placeholder="Select a value ..."    class="custom-select" >
                                                                ...
                                                                $field_value = $data['end_shift_day'];
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="form-group ">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <div class="input-group">
                                                                    <input id="ctrl-lunch_break_start" class="form-control datepicker  datepicker"  required="" value="<?php  echo $data['lunch_break_start']; ?>" type="time" name="lunch_break_start" placeholder="Enter Lunch Break Start" data-enable-time="true" data-min-date="" data-max-date=""  data-alt-format="H:i" data-date-format="H:i:S" data-inline="false" data-no-calendar="true" data-mode="single" /> 
                                                                        <div class="input-group-append">
                                                                            <span class="input-group-text"><i class="material-icons">access_time</i></span>
                                                                        </div>
                                                                    </div>
                                                        ...
                                                        <div class="form-group ">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <div class="input-group">
                                                                        <input id="ctrl-lunch_break_end" class="form-control datepicker  datepicker"  required="" value="<?php  echo $data['lunch_break_end']; ?>" type="time" name="lunch_break_end" placeholder="Enter Lunch Break End" data-enable-time="true" data-min-date="" data-max-date=""  data-alt-format="H:i" data-date-format="H:i:S" data-inline="false" data-no-calendar="true" data-mode="single" /> 
                                                                            <div class="input-group-append">
                                                                                <span class="input-group-text"><i class="material-icons">access_time</i></span>
                                                                            </div>
                                                                        </div>
