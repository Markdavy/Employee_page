                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="form-group ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <select required=""  id="ctrl-employee_status" name="employee_status"  placeholder="Select a value ..."    class="form-control" >
                                                                <option value="">Select</option>
                                                                <?php
                                            ...
                                            <div class="form-group ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="input-group">
                                                        <input type="time" id="ctrl-shift_time_in" value="<?php  echo $this->set_field_value('shift_time_in',date_now()); ?>" name="shift_time_in"> 
                                                ...
                                                <div class="form-group ">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="input-group">
                                                            <input type="time" id="ctrl-shift_time_out" value="<?php  echo $this->set_field_value('shift_time_out',date_now()); ?>" name="shift_time_out">  
                                                                    <div class="input-group-append">
                                                    ...
                                                    <div class="form-group ">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <div class="input-group">
                                                                <input type="time" id="ctrl-lunch_break_start" value="<?php  echo $this->set_field_value('lunch_break_start',date_now()); ?>" name="lunch_break_start">
                                                                        <div class="input-group-append">
                                                        ...
                                                        <div class="form-group ">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <div class="input-group">
                                                                    <input type="time" id="ctrl-lunch_break_end" value="<?php  echo $this->set_field_value('llunch_break_end',date_now()); ?>" name="lunch_break_end">
                                                                            <div class="input-group-append">
